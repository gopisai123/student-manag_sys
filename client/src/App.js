...
function App() {
  ...
  const handlesubmit = async (e) => {
    e.preventDefault();
    const data = await axiosClient.post("/create", formData);
    // const data = await axiosClient.post("/api/students/create", formData);
  ...
  const handleFilterBySemester = (e) => {
    setFilterBySemester(e.target.value);
  };
  ...
  const handleDelete = async (id) => {
    ...
    const data = await axiosClient.delete("/delete/" + id); 
    if (data.data.success) {
      getFetchData();
      alert(data.data.message);
    }
  ...
  const handleUpdate = async (e) => {
    ...
    const data = await axiosClient.put("/update", formDataEdit);
    if (data.data.success) {
      getFetchData();
      alert(data.data.message);
          ...
          <div className='filter-section'>
            <label>
              ...
              <input
                ...
                onChange={handleFilterBySemester}
            ...
            {dataList
              .filter(
                (student) =>
                  ...
                  (filterBySemester === "" ||
                    student.Semester.toString() === filterBySemester) &&
                  (filterByClass === "" ||
